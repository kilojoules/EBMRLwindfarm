...
The composition literature (energy composition, classifier guidance, residual policies, safety shields) implicitly assumes the segment-convex condition of \cref{sec:theory} without checking it.
