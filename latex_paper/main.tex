...
We do not have access to a wake-steering-effective $\pi_{\mathrm{perf}}$ for this layout (cf.\ \S\ref{sec:wf_results} caveat) so we again validate budget tracking rather than preservation of a large RL advantage on the power axis.
