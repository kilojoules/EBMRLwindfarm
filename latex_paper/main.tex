...
We identify a previously-unreported failure mode of this scheme on \emph{directional action manifolds}: when the controllers act on opposite sides of a non-convex cost ridge, the linear midpoint can have cost strictly higher than either endpoint---the schedule is \emph{anti-Pareto in $\sigma$}.
