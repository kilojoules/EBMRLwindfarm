...
We name this the \textbf{alignment hazard} and show in \Cref{sec:theory} that it arises whenever cost is non-convex along the segment $\pi_{\mathrm{perf}}\!\to\!\pi_{\mathrm{safe}}$.
...
(2)~A \emph{sufficient condition} for monotonicity (cost convex on the segment $\pi_{\mathrm{perf}}\!\to\!\pi_{\mathrm{safe}}$) with a clean minimal counterexample (\Cref{sec:theory}).
